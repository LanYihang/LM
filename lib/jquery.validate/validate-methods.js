...
$(function(){
    ...
    // 判断整数value介于101~199
    jQuery.validator.addMethod("isIntGtMax", function (value, element) {
        value = parseInt(value);
        return this.optional(element) || (value > 100 && value<200);
    }, "介于100~200"); 
    ...
    // 匹配汉字 字符 数字
    jQuery.validator.addMethod("isLSChinese", function(value, element) {
    ...
    jQuery.validator.addMethod("isExcel",function (value,element){
        if(this.optional(element) || value.toLowerCase().indexOf(".xls")>0 || value.toLowerCase().indexOf(".xlsx")>0)
            return true;
        else
            return false;
    },"只允许Excel文件");
